...
var CONFIG = {
    SMTP_USERNAME: process.env.SMTP_USERNAME || "example@gmail.com",
    SMTP_PASSWORD: process.env.SMTP_PASSWORD,
    SMTP_HOST: process.env.SMTP_HOST || "smtp.gmail.com",
    SMTP_PORT: parseInt(process.env.SMTP_PORT) || 465,
    SMTP_FROM_NAME: process.env.SMTP_FROM_NAME || "Example",
    SMTP_FROM_EMAIL: process.env.SMTP_FROM_EMAIL || "example@gmail.com",
    SMTP_FROM_SUBJECT: process.env.SMTP_FROM_SUBJECT || " New data",
    SMTP_TO: process.env.SMTP_TO || "example@gmail.com",
